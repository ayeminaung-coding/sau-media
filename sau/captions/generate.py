    ...
    return "\n".join(
        [
            ...
            *lines,
            ...
            "- Vary the shape from episode to episode. With a thin synopsis the",
            "  temptation is to fall back on the same skeleton every time -- two",
            "  rhetorical questions and an invitation to watch -- which reads as one",
            "  caption repeated N times. Open some on a statement, some on a line of",
            "  dialogue, some mid-scene; end some on a question and some on a beat.",
            "- Never close on a call to watch -- in Burmese the",
            "  ဒီအပိုင်းမှာ ကြည့်လိုက်ရအောင် / ကြည့်လိုက်ပါ family. The reader is already on the",
            "  video, so it is filler. End on the story instead.",
